...
export const neutralTheme = defineTheme({
  ...
  tokens: {
    ...
    // 케어브이 브랜드 틸. 라이트 액센트는 teal-700(#0f766e) — 흰 라벨 대비 4.6:1로
    // teal-600(#0d9488, 3.0:1)보다 안전하면서 브랜드 인상은 동일하다.
    '--color-accent':       ['#0f766e', '#2dd4bf'],
    '--color-accent-muted': ['#f0fdfa', '#134e4a'],
    ...
    // Contrast: brand teal accent (L) / bright teal (D)
    '--color-on-accent':  ['#ffffff', '#062f2b'],
    '--color-on-success': ['#ffffff', '#171717'],
    '--color-on-error':   ['#ffffff', '#171717'],
    '--color-on-warning': '#171717',

    // Icon
    '--color-icon-accent':    ['#0f766e', '#2dd4bf'],
