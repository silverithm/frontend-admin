              ...
              {!isEditing && (
                <div className="flex flex-col sm:flex-row gap-2">
                  <button
                    ...
                    className="px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-all duration-200 shadow-sm flex items-center gap-2"
                  >
