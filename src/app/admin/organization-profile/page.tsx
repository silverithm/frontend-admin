                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                      ...
                      <button
                        ...
                        className="w-full px-4 py-2 text-sm font-medium text-blue-600 bg-white border border-blue-300 rounded-lg hover:bg-blue-50 transition-all duration-200"
                      >
                        비밀번호 변경하기
                      </button>
                    </div>
                    ...
                    <div className="bg-red-50 rounded-xl p-6 border border-red-200">
                      <div className="flex items-center mb-4">
                        ...
                        <div>
                          <h4 className="font-medium text-gray-900">회원탈퇴</h4>
                          <p className="text-sm text-gray-500">모든 데이터가 삭제되며 복구할 수 없습니다</p>
                        </div>
                      </div>
                      <button
                        onClick={() => setShowDeleteModal(true)}
                        className="w-full px-4 py-2 text-sm font-medium text-red-600 bg-white border border-red-300 rounded-lg hover:bg-red-50 transition-all duration-200"
                      >
                        회원탈퇴
                      </button>
                    </div>
