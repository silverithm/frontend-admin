...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    target: 'nav-approval',
    tab: 'approval',
    title: '회의록처럼 여럿이 보셔야 하는 문서라면',
    description:
      '양식을 만드실 때 "열람 대상"에서 직책을 체크해두세요.\n예를 들어 사회복지사를 체크하시면, 그 직책 직원분들이\n이 양식으로 올라온 문서를 모두 보실 수 있습니다.\n\n특정 직원분만 따로 넣으실 수도 있고,\n관리자와 결재선에 계신 분은 지정하지 않아도 늘 보실 수 있어요.',
    adminOnly: true,
  },
  {
    target: 'nav-approval',
    tab: 'approval',
    title: '지난 문서는 검색으로 찾으세요',
    description:
      '제목이나 기안자뿐 아니라 양식 이름, 문서번호, 첨부파일 이름,\n문서에 적힌 내용, 결재하신 분 이름으로도 찾아집니다.\n\n다만 기간이 이번 달로 잡혀 있어서,\n오래된 문서를 찾으실 땐 시작일을 앞으로 당겨주세요.',
  },
