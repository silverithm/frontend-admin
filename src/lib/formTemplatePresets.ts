    ...
    schema: {
      ...
      fields: [
        ...
        },
        {
          ...
          label: '진단서 첨부',
          required: true,
          description: '병가는 진단서가 필요합니다',
          visibleWhen: {
            match: 'all',
            conditions: [{ fieldId: 'leave-type', operator: 'equals', value: 'sick' }],
          },
        },
      ],
    },
    ...
    schema: {
      ...
      fields: [
        ...
        },
        {
          ...
          computed: {
            operation: 'sum',
            sourceFieldIds: ['transport-cost', 'accommodation-cost', 'meal-cost', 'other-cost'],
            unit: '원',
          },
        },
        {
      ...
      fields: [
        {
          ...
          label: '구매 품목',
          required: true,
          description: '품목이 여러 개면 행을 추가하세요',
          repeater: {
            minRows: 1,
            addLabel: '품목 추가',
            fields: [
              { id: 'item-name', type: 'text', label: '품명', required: true, width: 'half' },
              { id: 'item-qty', type: 'number', label: '수량', required: true, width: 'quarter', validation: { min: 1 } },
              { id: 'item-amount', type: 'number', label: '금액', required: true, width: 'quarter', placeholder: '원', validation: { min: 0 } },
            ],
          },
        },
        {
          ...
          computed: {
            operation: 'sum',
            sourceRepeaterId: 'items',
            sourceRepeaterFieldId: 'item-amount',
            unit: '원',
          },
        },
        {
